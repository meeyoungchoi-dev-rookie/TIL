...
- [o]  포트폴리오 수정 및 입사지원
- [o]  팀프로젝트 백엔드 코드 리펙토링
    - [o]  **Feature: 코드 리펙토링 - 스터디 참여신청시 현재 참여인원스 계산하는 코드 수정**
- [o]  예전에 만들어 뒀던 쇼핑몰 프로젝트 잘 동작하는지 확인
- [o]  쇼핑몰 프로젝트 리펙토링을 위해 UI기획서 , 기술명세서 정리

# 7월 6일
+ 팀프로젝트 백엔드 코드 리펙토링
+ 코드 리펙토링 - 로그인후 스터디 조회시 role 판단하는 메서드 중첩 if문 제거 및 코드 수정
+ 포트폴리오 멘토링

# 7월 9일
+ 팀프로젝트 백엔드 컨트롤러 코드 리펙토링
+ 코드 리펙토링 - 불필요한 import 제거
+ 기술면접 후기 작성
+ http vs https 차이 정리
+ 스택 vs 큐 차이 정리

# 7월 12일
- [o]  포트폴리오 진행했던 프로젝트 영역 내용 수정
- [o]  내일 있을 면접 대비 포트폴리오 정리
- [o]  팀프로젝트 백엔드 프로젝트 - 공유로그 목록 조회시 작성자에 대한 회원 정보가 존재하지 않는 경우 던지는 예외 수정

# 7월 14일
- [o]  기술면접 후기 작성
- [o]  AWS 강의 들으며 실습
- [o]  포트폴리오 멘토링 기반 내용 수정
